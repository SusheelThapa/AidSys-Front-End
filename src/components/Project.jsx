  ...
  return (
    <>
      <div className="mx-10 my-12">
        <h1 className="text-3xl text-assets-100 font-bold  font-serif">Project Name</h1>
        <div className="flex space-x-10 2xl:space-x-48">
          ...
          <div className="w-2/5 flex-col flex justify-center">
            ...
            {/* left arrow */}
            <div className="absolute top-[40%] bg-white bg-opacity-50 mx-3 cursor-pointer rounded-full -translate-x-0 translate-y-[50] hidden group-hover:block" onClick={prevSlide}>
              <BsChevronCompactLeft size={60} />
            </div>
            <div className="absolute top-[40%] bg-white bg-opacity-50 cursor-pointer rounded-full -translate-x-0 translate-y-[50] right-5 hidden group-hover:block" onClick={nextSlide}>
              {/* right arrow */}
