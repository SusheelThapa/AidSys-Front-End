    ...
    <div>
      <div className="box">
        <ul className="list-group">
          ...
          <li className="list-group-item">
            Untagged Items<span className="badge bg-primary rounded-pill">0</span>
          </li>
          <li className="list-group-item">
        ...
        <ol className="list-group list-group">
          <li className="list-group-item d-flex justify-content-between align-items-start">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="bi bi-cloud-upload transparent-bg" viewBox="0 0 16 16">
